...
const M4 = {
  ...
  // Day 5 (Jan 11): UB SF ×2
  'M420230111M1': { day: 5, round: 'UB Semi-Final' },
  'M420230111M2': { day: 5, round: 'UB Semi-Final' },
  // Day 6 (Jan 12): LB R3 ×2 (4 LB R2 winners)
  'M420230112M1': { day: 6, round: 'LB Round 3' },
  'M420230112M2': { day: 6, round: 'LB Round 3' },
...
const M2 = {
  ...
  // Day 1 (Jan 22): UB SF ×2 + LB R1 ×2
  'M220210122M1': { day: 1, round: 'UB Semi-Final' },
  'M220210122M2': { day: 1, round: 'UB Semi-Final' },
  'M220210122M3': { day: 1, round: 'LB Round 1' },
  'M220210122M4': { day: 1, round: 'LB Round 1' },
...
const M3 = {
  ...
  // LB R1 starts concurrently with last UB QF day; UB SF starts day after UB QF done.
  // Day 1 (Dec 11): UB QF ×2
  'M320211211M1': { day: 1, round: 'UB Quarter-Final' },
  'M320211211M2': { day: 1, round: 'UB Quarter-Final' },
  // Day 2 (Dec 12): UB QF ×2 + LB R1 ×1 (starts concurrently)
  'M320211212M1': { day: 2, round: 'UB Quarter-Final' },
  'M320211212M2': { day: 2, round: 'UB Quarter-Final' },
  'M320211212M3': { day: 2, round: 'LB Round 1' },
  // Day 3 (Dec 13): LB R1 ×3 (completing) + UB SF ×1 (UB QF done Dec 12)
  'M320211213M1': { day: 3, round: 'LB Round 1' },
  'M320211213M2': { day: 3, round: 'LB Round 1' },
  'M320211213M3': { day: 3, round: 'LB Round 1' },
  'M320211213M4': { day: 3, round: 'UB Semi-Final' },
  // Day 4 (Dec 14): LB R2 ×4 (LB R1 and UB QF both complete)
  ...
  // Day 5 (Dec 15): UB SF ×1 (completing) + LB R3 ×1 (LB R2 done Dec 14)
  'M320211215M1': { day: 5, round: 'UB Semi-Final' },
  'M320211215M2': { day: 5, round: 'LB Round 3' },
  // Day 6 (Dec 16): LB R3 ×1 (completing) + LB QF ×1 (starts after LB R3 done)
  'M320211216M1': { day: 6, round: 'LB Round 3' },
  'M320211216M2': { day: 6, round: 'LB Quarter-Final' },
  // Day 7 (Dec 17): LB QF ×1 (completing) + UB Final ×1 (UB SF done Dec 15)
  'M320211217M1': { day: 7, round: 'LB Quarter-Final' },
  'M320211217M2': { day: 7, round: 'UB Final' },
  // Day 8 (Dec 18): LB SF ×1 + LB Final ×1 + 1 unresolved match (Dec 18 M3 unlabeled)
  'M320211218M1': { day: 8, round: 'LB Semi-Final' },
  'M320211218M2': { day: 8, round: 'LB Final' },

  // ── Finals (Dec 19 local) ─────────────────────────────────────────────────
  'M320211219M1': { day: 1, round: 'Grand Final' },
};

const MAPS = { M2, M3, M4, M5, M6, M7 };
