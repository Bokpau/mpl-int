...
//   SE — MSC 2025:  8-team single-elim QF→SF→GF + 3rd Place (separate column)
//
...
// SE shape uses section:'se' (no UB/LB split). The 'third' section has no
// feeds — no connector lines are drawn from SF losers to the 3rd place match.

const SHAPES = {
  // ── Single Elimination (MSC 2025) ──────────────────────────────────────────
  SE: {
    columns: [
      { se: 'qf'    },
      { se: 'sf'    },
