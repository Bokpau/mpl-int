...
const LAYOUTS = {
  ...
  'MSC 2026': {
    shape: 'SE3P',
    bo: { qf: 'Bo5', sf: 'Bo5', gf: 'Bo7', third: 'Bo5' },
    // Codes verified against the live /api/intl/schedule feed (2026-07-30): QF1/QF2
    // played 7/29 (M1/M2), QF3/QF4 play 7/30 (M1/M2). SF/3rd/GF have no scheduled
    // code yet — mc left null so a slot doesn't wrongly bind to a later day's match
    // number before MLBB publishes it (previously guessed as 0729M3/M4, which
    // collided with 0730's real matches and made SF1 render the live QF).
    slots: {
      qf0:    { mc: 'MSC20260730M1', top: 'VMS', bottom: 'TS'   },
      qf1:    { mc: 'MSC20260730M2', top: 'AUR', bottom: 'ONIC' },
      qf2:    { mc: 'MSC20260729M2', top: 'VIT', bottom: 'FLCN' },
      qf3:    { mc: 'MSC20260729M1', top: 'YG',  bottom: 'PRO'  },
      sf0:    { mc: null, top: null,  bottom: null   },
      sf1:    { mc: null, top: null,  bottom: null   },
      gf0:    { mc: null, top: null,  bottom: null   },
      third0: { mc: null, top: null,  bottom: null   },
    },
  },
};
