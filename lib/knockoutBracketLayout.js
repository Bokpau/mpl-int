...
const LAYOUTS = {
  ...
  'MSC 2026': {
    shape: 'SE3P',
    bo: { qf: 'Bo5', sf: 'Bo5', gf: 'Bo7', third: 'Bo5' },
    // Codes verified against the live schedule feed: QF1/QF2 are 7/29 M1/M2, QF3/QF4
    // are 7/30 M1/M2. SF/3rd/GF have no scheduled code yet, so mc stays null — the
    // earlier guesses (sf0 = MSC20260730M1) collided with a real quarterfinal's code
    // and made the Semifinal box render the live QF series.
    slots: {
