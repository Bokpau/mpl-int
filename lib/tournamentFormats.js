    ...
    stages: [
      {
        ...
        bo: 'Bo3',
        advances: 4,
        note: '4 groups of 3, RR Bo3. Group winners→UB, 2nd/3rd→play-in.',
      },
      {
        ...
        bo: 'Bo3',
        advances: 4,
        note: '4 play-in matches. Winners→LB. Stored as "Regular Season" in DB.',
      },
      {
        db_stage: 'Playoffs',
        db_stage_type: 'main',
        ...
        teams: 8,
        bo: { early: 'Bo3', ub_lb_finals: 'Bo5', final: 'Bo7' },
        note: '8-team double-elim (UB SF + LB R1 start). GF split to "Finals".',
      },
      {
        db_stage: 'Finals',
        db_stage_type: 'main',
