...
export const JUNGLE_CAMPS = [
  ...
  camp('Horned Lizard',  'blue', -14.10,  21.20, 40, 70, 'HP & mana regen',                 1),
  camp('Horned Lizard',  'red',   14.10, -21.20, 40, 70, 'HP & mana regen',                 1),
  camp('Lava Golem',     'blue', -10.90, -12.00, 31, 70, 'HP & mana regen',                 1),
  camp('Lava Golem',     'red',   10.90,  12.00, 31, 70, 'HP & mana regen',                 1),
  camp('Fire Beetle',    'blue', -10.80, -23.60, 39, 70, 'HP & mana regen',                 2),
  camp('Fire Beetle',    'red',   11.06,  23.50, 39, 70, 'HP & mana regen',                 2),
